...
int main() {
	...
	//get more info on a shader object then compile
	...
	//get more info on the fragment shader then attempt to compile
	...
	//attach both vertex and fragment shader to the shader program
